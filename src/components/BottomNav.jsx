...
export default function BottomNav({ t, activeTab, setActiveTab }) {
    return (
        <nav className="fixed bottom-0 inset-x-0 bg-[#14161b]/95 backdrop-blur-md border-t border-slate-800 py-3 px-16 flex justify-between items-center z-40 pb-safe shadow-2xl">
            <button
            ...
            {/* Spacer button for symmetric layout */}
